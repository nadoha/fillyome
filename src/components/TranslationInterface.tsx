    ...
    <SidebarProvider defaultOpen={false}>
      <div className="h-screen flex w-full bg-gradient-to-br from-background via-background to-muted/20 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 flex flex-col px-4 sm:px-6 py-4 sm:py-6 animate-fade-in overflow-y-auto touch-pan-y overscroll-contain">
            <div className="w-full max-w-5xl mx-auto flex-1 flex flex-col gap-4 sm:gap-6 pb-[calc(2rem+env(safe-area-inset-bottom))]">
              {!isOnline && (
              ...
              <div className={`flex-1 flex flex-col gap-4 sm:gap-6 transition-all duration-500 ${sourceText.trim() ? '' : 'justify-center'}`}>
