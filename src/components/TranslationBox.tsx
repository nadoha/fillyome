...
export const TranslationBox = memo(({
    ...
    return (
      <div className="relative group animate-fade-in h-full">
        <Textarea
          ...
          className="h-full min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:min-h-[420px] xl:min-h-[480px] resize-none text-sm sm:text-base md:text-lg leading-relaxed border-2 border-border/60 bg-card/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 lg:p-7 pr-12 sm:pr-14 md:pr-16 lg:pr-20 focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-primary shadow-sm hover:shadow-md transition-all duration-200"
        ...
        {value && (
          <div className="absolute top-3 right-3 sm:top-4 sm:right-4 md:top-5 md:right-5 flex gap-1.5 sm:gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-all duration-200">
            <Button
              variant="outline"
              size="icon"
              className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 lg:h-11 lg:w-11 rounded-lg sm:rounded-xl border-border/60 bg-card/80 backdrop-blur-sm hover:bg-primary hover:text-primary-foreground hover:border-primary shadow-sm transition-all duration-200"
              onClick={onCopy}
            >
  ...
  return (
    <div className="relative group animate-fade-in h-full">
      <div 
        className="h-full min-h-[250px] sm:min-h-[300px] md:min-h-[350px] lg:min-h-[420px] xl:min-h-[480px] border-2 border-border/60 bg-muted/40 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 lg:p-7 pr-12 sm:pr-14 md:pr-16 lg:pr-20 select-text transition-all duration-200 hover:bg-muted/50 hover:border-primary/30 shadow-sm"
        style={{ boxShadow: 'var(--shadow-sm)' }}
