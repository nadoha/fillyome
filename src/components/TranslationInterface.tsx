    ...
    <SidebarProvider defaultOpen={false}>
      <div className="h-screen flex w-full bg-gradient-to-br from-background via-background to-muted/20 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 flex flex-col px-3 sm:px-4 py-3 sm:py-4 animate-fade-in overflow-y-auto touch-pan-y overscroll-contain">
            <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col gap-3 sm:gap-4 pb-[calc(2rem+env(safe-area-inset-bottom))]">
              {!isOnline && (
